                ...
                <form action="register/register.php" method="post">
                    ...
                    <ul class="fields">
                        <div class="Refer_w3l">
                            ...
                            <li>
                                <label class="w3ls-opt">Fecha de cumpleaños:<span class="w3ls-star"> * </span></label>	

                                <div class="w3ls-text w3ls-name">
                                    <span class="text">    
                                        <input type="text" id="cumple" name="cumple" placeholder="Fecha de Cumpleaños" required="">
                                    </span>                                   
                                </div>
