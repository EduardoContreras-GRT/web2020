...
<!--[if !IE]><!--> <html dir="ltr">             <!--<![endif]-->
    <head>
        <title>Boletin - Postal</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
        <meta name="description" content="Boletin - Postal Email Forms">
        <meta name="keywords" content="Boletin - Postal">
    ...
    <body>
        ...
        <div class="wrapper rounded6" id="templateContainer">
            <h1 class="masthead">Suscr&iacute;bete a nuestro bolet&iacute;n aqu&iacute;:</h1>

            <div id="templateBody" class="bodyContent rounded6">

                <div id="subscribeFormWelcome"><div style="text-align: left;"><span style="font-family:arial,helvetica neue,helvetica,sans-serif">Tu formaci&oacute;n es importante, por &eacute;sto contamos</span></div>

                    <div style="text-align: left;"><span style="font-family:arial,helvetica neue,helvetica,sans-serif">con un blog donde constantemente publicamos art&iacute;culos de tu inter&eacute;s.</span></div>
                </div>
                <div class="indicates-required"><span class="asterisk">*</span> Indica que es obligatorio</div>



                <form action="https://grt.us15.list-manage.com/subscribe/post" method="POST">
                    <input type="hidden" name="u" value="b620f3793dc7207439e155fda">
                    <input type="hidden" name="id" value="4d9033f02f">
                    ...
                    <div id="mergeTable" class="mergeTable">
                        ...
                        <div class="mergeRow dojoDndItem mergeRow-email" id="mergeRow-0">
                            <label for="MERGE0">Correo elect&oacute;nico <span class="req asterisk">*</span></label>
                        ...
                        <div class="mergeRow dojoDndItem mergeRow-text" id="mergeRow-3">
                            <label for="MERGE3">Nombre completo <span class="req asterisk">*</span></label>
                            <div class="field-group">
                        ...
                        <div class="mergeRow dojoDndItem mergeRow-birthday" id="mergeRow-1">
                            <label for="MERGE1">Cumeplea&ntilde;os <span class="req asterisk">*</span></label>
                            <div class="field-group">
                                <div class="birthdayfield subfields borderbox"><span class="subfield dayfield"><label for="MERGE1-day">Day</label><input type="text" pattern="[0-9]*" id="MERGE1-day" name="MERGE1[day]" maxlength="2" size="2" value="" placeholder="DD"></span> / <span class="subfield monthfield"><label for="MERGE1-month">Month</label><input type="text" pattern="[0-9]*" id="MERGE1-month" name="MERGE1[month]" maxlength="2" size="2" value="" placeholder="MM"></span></div>
                    ...
                    <div class="submit_container clear">
                        <input type="submit" class="button" name="submit" value="Suscribirse">
                    </div>
                    <input type="hidden" name="ht" value="47d620ff5ad0981aa46f0fdc5dd6c7cb15679ea8:MTUwNTMzMDU0MC42Mw==">
